/*
	...
	DZAI_maxHeliPatrols = 2;									//Maximum number of active AI helicopters patrols. (Default: 0).
	DZAI_heliTypes = ["Mi17_UN_CDF_EP1"];						//Classnames of helicopter types to use. (Default: "UH1H_DZ").
